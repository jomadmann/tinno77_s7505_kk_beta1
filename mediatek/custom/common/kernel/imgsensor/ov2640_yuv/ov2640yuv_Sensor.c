...
#else
	OV2640WriteCmosSensor(0x90, 0x00);		//20121018 use this data if exposure when high light           by lishengli
	OV2640WriteCmosSensor(0x91, 0x0d);
	OV2640WriteCmosSensor(0x91, 0x1a);
	OV2640WriteCmosSensor(0x91, 0x31);
	OV2640WriteCmosSensor(0x91, 0x54);
	OV2640WriteCmosSensor(0x91, 0x5f);
	OV2640WriteCmosSensor(0x91, 0x6a);
	OV2640WriteCmosSensor(0x91, 0x74);
	OV2640WriteCmosSensor(0x91, 0x7c);
	OV2640WriteCmosSensor(0x91, 0x84);
	OV2640WriteCmosSensor(0x91, 0x8c);
	OV2640WriteCmosSensor(0x91, 0x9a);
	OV2640WriteCmosSensor(0x91, 0xa7);
	OV2640WriteCmosSensor(0x91, 0xbf);
	OV2640WriteCmosSensor(0x91, 0xd3);
	OV2640WriteCmosSensor(0x91, 0xe2);
	OV2640WriteCmosSensor(0x91, 0x28);
...
/*	OV2640WriteCmosSensor(0x90, 0x00);
	...
	OV2640WriteCmosSensor(0x93, 0x02);//  03 //sharpness ,the lower the better 
	OV2640WriteCmosSensor(0x93, 0x06);//  03 //sharpness ,the higher the better
	OV2640WriteCmosSensor(0x93, 0x00); 
	OV2640WriteCmosSensor(0x93, 0x02);

	//matrix
#if 0							//20121018   by lishengli
...
#else
	OV2640WriteCmosSensor(0x96, 0x00);
	OV2640WriteCmosSensor(0x97, 0x07);
	OV2640WriteCmosSensor(0x97, 0x19);
	OV2640WriteCmosSensor(0x97, 0x02);
	OV2640WriteCmosSensor(0x97, 0x0c);//cmx-3
	OV2640WriteCmosSensor(0x97, 0x24);
	...
	OV2640WriteCmosSensor(0x97, 0x28);
	OV2640WriteCmosSensor(0x97, 0x26);
	OV2640WriteCmosSensor(0x97, 0x01);
	OV2640WriteCmosSensor(0x97, 0x98);
	OV2640WriteCmosSensor(0x97, 0x80);
	OV2640WriteCmosSensor(0x97, 0x00);
	OV2640WriteCmosSensor(0x97, 0x00);
	...
	OV2640WriteCmosSensor(0xb0, 0x6b);//0x46		//0x85		20121018   by lishengli
	OV2640WriteCmosSensor(0xb1, 0x50);//0x46
	OV2640WriteCmosSensor(0xb2, 0x03);//0x06
	#else
	OV2640WriteCmosSensor(0xb6, 0x33);
	OV2640WriteCmosSensor(0xb8, 0x47);
	OV2640WriteCmosSensor(0xb7, 0x25);
	OV2640WriteCmosSensor(0xb9, 0x3b);
	OV2640WriteCmosSensor(0xb3, 0xaa);
	OV2640WriteCmosSensor(0xb4, 0xff);
	OV2640WriteCmosSensor(0xb5, 0x58);//0x35
	OV2640WriteCmosSensor(0xb0, 0x58);//0x46
	OV2640WriteCmosSensor(0xb1, 0x4b);//0x46
	OV2640WriteCmosSensor(0xb2, 0x04);//0x06
	#endif
	OV2640WriteCmosSensor(0xc7, 0x00);
	OV2640WriteCmosSensor(0xc6, 0x51);
	OV2640WriteCmosSensor(0xc5, 0x11);
	OV2640WriteCmosSensor(0xc4, 0x97);
...
static void OV2640PreviewSetting(void)
{
	...
	OV2640WriteCmosSensor(0x7c,0x03);
	OV2640WriteCmosSensor(0x7d,0x47);
	OV2640WriteCmosSensor(0x7d,0x47);
...
static void OV2640GetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = OV2640Sensor.iwb;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_VIDEO_MODE:
			...
			OV2640GetExifInfo(*pFeatureData32);
			break;
		/*#if defined(MT6575)
